...
public class Carro {
    ...
    public static class CarroBuilder {
        ...
        public Carro build() {
            if (placa == null || placa.isEmpty()) throw new NullPointerException("É necessário informar a placa do carro.");
            if (cor == null) throw new NullPointerException("É necessário informar a cor do carro.");
            if (motorista == null) throw new EstacionamentoException("É necessário informar as informações do motorista.");
