...
public class CandidateController {
    ...
    @GetMapping
    public List<Candidate> findByCompanyIdOrAccelerationId(@RequestParam(required = false) Long companyId, @RequestParam(required = false) Long accelerationId) {
        if (companyId == null) this.candidateService.findByAccelerationId(accelerationId);
